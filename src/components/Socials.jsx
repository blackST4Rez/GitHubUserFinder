    ...
    return (
        <>
            <div className='mt-4 flex flex-col md:flex-row gap-3'>
                <div className='flex w-full items-center justify-center gap-1 px-4 py-2.5 text-black md:w-1/3'>
                    <LucideMapPinHouse size={24} className='shrink-0 sm:size-7.5' />
                    <h5 className='text-base font-light sm:text-lg lg:text-2xl truncate'>{noLocation()}</h5>
                </div>
                <div className='flex w-full items-center justify-center gap-1 px-4 py-2.5 text-black md:w-1/3'>
                    <LiaLinkSolid size={24} className='shrink-0 sm:size-7.5' />
                    <h5 className='text-center text-base font-light sm:text-lg lg:text-2xl truncate'>{user.html_url}</h5>
                </div>
                <div className='flex w-full items-center justify-center gap-1 px-4 py-2.5 text-black md:w-1/3'>
